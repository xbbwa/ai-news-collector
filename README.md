...
| `rsshub` | 自建 RSSHub，把没有 RSS 的站点（Anthropic、DeepSeek、36氪、虎嗅、晚点、智源社区、HF Daily Papers、GitHub Trending）转成 RSS，端口 1200 |
| `redis` | RSSHub 缓存 |
...
- **Tier 1 一手（国外）**：OpenAI、Anthropic（News/Research/Engineering，RSSHub）、DeepMind、Google AI / Google Research / Google Cloud AI、Meta Engineering + Meta 新闻室、Hugging Face 博客、Microsoft Research、NVIDIA 博客 + 技术博客、AWS ML、Amazon Science、Apple ML Research、Mistral、GitHub 博客（Copilot）、Databricks、EleutherAI、arXiv（cs.AI/CL/LG/CV）、HF Daily Papers（RSSHub）、HF 模型发布（26 个国外机构：openai、meta-llama、google、microsoft、nvidia、mistralai、CohereLabs、allenai、stabilityai、black-forest-labs、apple、xai-org 等）
...
- **Tier 2 媒体（国内）**：量子位、智东西、InfoQ、36氪快讯 + AI 频道（RSSHub）、虎嗅（RSSHub）、晚点 LatePost（RSSHub）、钛媒体、爱范儿、极客公园、IT之家、少数派、雷峰网、开源中国
- **Tier 3 社交/聚合**：Hacker News（22 个查询词）、Reddit 7 个板块合并（MachineLearning、LocalLLaMA、artificial、singularity、OpenAI、ClaudeAI、StableDiffusion；new + hot 两路）、GitHub Trending（RSSHub）、Product Hunt AI、智源社区（RSSHub）
...
实测（2026-09-06，本机直连，`scripts/check_sources.py`）：61 个直连源全部正常，11 个 RSSHub 源本机未起容器未测（路由已对照 RSSHub 源码逐条核实）。HF 模型源一轮返回国内 429 / 国外 487 个模型，7 天内新增或更新的分别 41 / 72 个。
